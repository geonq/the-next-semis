...
#   - https://hub.docker.com/_/node/tags - for npm assets
#
...
FROM docker.io/node:${NODE_VERSION} AS node_deps
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/the_next_semis ./

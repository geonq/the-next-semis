...
export interface AreaChartProps {
  ...
  /**
   * `"zero"` (default) pins the domain to `[0, max*1.1]`. `"data"` hugs
   * `[min, max]` with ~5% padding — use for price-style series where a
   * zero baseline would flatten the visible range.
   */
